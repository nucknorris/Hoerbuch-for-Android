...
\usepackage{booktabs}			
 \usepackage{titlepic}														% Nicer tables
...
\title{ \vspace{-1in} 	\usefont{OT1}{bch}{b}{n}
		...
		\Large \bfseries \ Android-Anwendungen am praktischen Beispiel einer Applikation für Hörbücher \strut
}
\author{ 									
        \usefont{OT1}{bch}{m}{n}
...
\date{        
        \vspace{2cm}
        \includegraphics[scale=0.35]{images/title}}
